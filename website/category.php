...
if (isset($_GET['edit'])) {
    ...
    $edit_query = "SELECT * FROM Category WHERE CategoryID = $id_to_edit";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $safe_value = $conn->real_escape_string($_POST['CategoryName']);
    $CategoryName = "'" . $safe_value . "'";
...
if ($search_keyword != '') {
    ...
    $where_sql = " WHERE (" . "CategoryID LIKE '%$search_keyword%'" . " OR " . "CategoryName LIKE '%$search_keyword%'" . ")";
}

// Combine query parts and fetch the final results for the table
$final_query = "SELECT * FROM Category" . $where_sql . "";
...
<html>
<head>
    <title>Category - KompyuTek</title>
...
<body>
    <div class="sidebar">
        ...
        <?php
        $category_nav_class = ""; if ("Category" == "Category") $category_nav_class = "active";
        $manufacturer_nav_class = ""; if ("Category" == "Manufacturer") $manufacturer_nav_class = "active";
        $users_nav_class = ""; if ("Category" == "Users") $users_nav_class = "active";
        $supplier_nav_class = ""; if ("Category" == "Supplier") $supplier_nav_class = "active";
        $part_nav_class = ""; if ("Category" == "Part") $part_nav_class = "active";
        $inventory_nav_class = ""; if ("Category" == "Inventory") $inventory_nav_class = "active";
        $stock_nav_class = ""; if ("Category" == "StockTransaction") $stock_nav_class = "active";
        ?>
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <h1>Category</h1>
                <p>Manage and track your category records here.</p>
            </div>
        ...
        <div class="card">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    $input_value = "";
                    if (isset($edit_row)) {
                        $input_value = htmlspecialchars($edit_row['CategoryName']);
                    }
                    ?>
                    <input type="text" name="CategoryName" value="<?= $input_value ?>" required>
                </div>
        ...
        <div class="card toolbar-card">
            ...
            <form method="GET" class="search-form">
                ...
                <?php if($search_query != ''): ?>
                <a href="category.php"><button type="button" class="btn-outline btn-clear">Clear</button></a>
                <?php endif; ?>
            </form>
        </div>
        ...
        <div class="card table-card">
            <table>
                <thead>
                    <tr>
                        <th>CategoryID</th><th>CategoryName</th>
                    ...
                    if ($result) {
                        if ($result->num_rows > 0) {
                            ...
                            if (isset($row['CategoryID'])) {
                                $table_cell_value = htmlspecialchars($row['CategoryID']);
                            }
                            ?>
                            ...
                            <td><?= $table_cell_value ?></td>
                                    ...
                                    <td class="action-cell">
                                        <a href="?edit=<?= $row['CategoryID'] ?>"><button class="btn-outline btn-sm mr-sm">Edit</button></a>
                                        <a href="?delete=<?= $row['CategoryID'] ?>" onclick="return confirm('Are you sure you want to delete this record?')"><button class="btn-danger btn-sm">Delete</button></a>
                                    </td>
                                </tr>
                                <?php
                            }
