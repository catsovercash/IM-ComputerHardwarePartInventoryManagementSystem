...
if (isset($_GET['delete'])) {
    ...
    if ("Manufacturer" === "StockTransaction") {
        $get_old_transaction_sql = "SELECT * FROM StockTransaction WHERE ManufacturerID = $id_to_delete";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['update_id']) && $_POST['update_id'] != '') {
        ...
        if ("Manufacturer" === "StockTransaction") {
            $get_old_transaction_sql = "SELECT * FROM StockTransaction WHERE ManufacturerID = $id_to_update";
            $transaction_result = $conn->query($get_old_transaction_sql);
            if ($transaction_result) {
                $old_transaction = $transaction_result->fetch_assoc();
                if ($old_transaction) {
...
<html>
<head>
    <title>Manufacturer - IM System</title>
